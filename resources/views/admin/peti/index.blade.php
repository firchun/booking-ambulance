    ...
    <div class="dashboard-content card d-flex flex-column p-4 bg-white">
        ...
        <div class="form-action d-flex flex-row w-100 justify-content-between pb-4">
            <div class="buttons d-flex flex-row gap-2">
                <a href="{{ route('peti.create') }}" class="btn btn-primary"><i class="uil uil-plus"></i>&nbsp;Tambah
                    Peti</a>
            </div>
        </div>
                    ...
                    @foreach ($data as $row)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="buttons">
                                    <a href="{{ route('peti.edit', $row->id) }}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-edit"></i></a>
                                    <button onclick="triggerDelete('{{ route('peti.destroy', $row->id) }}')"
