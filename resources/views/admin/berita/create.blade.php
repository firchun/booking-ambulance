...
@section('main-content')
    ...
    <div class="dashboard-content card d-flex flex-column p-4 bg-white">
        <div class="dashboard-title">
            <i class="uil uil-plus"></i>&nbsp;Tambah Berita
        </div>
        <hr class="pb-4">
        <form action="{{ route('berita.store') }}" class="form" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 d-flex flex-column gap-2">
                <label for="" class="control-label fw-bold">Foto Berita</label>
            ...
            <div class="mb-3 d-flex flex-column gap-2">
                ...
                <textarea name="isi_berita" class="form-control @error('isi_berita') is-invalid @enderror"></textarea>
                @error('isi_berita')
                    <small class="text-danger fw-bold">{{ $message }}</small>
                @enderror
            </div>
