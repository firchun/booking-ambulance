                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                                <div class="buttons">
                                    <a href="{{ route('supir.edit', $row->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                    <button onclick="triggerDelete('{{ route('supir.destroy', $row->id) }}')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        @endforeach
