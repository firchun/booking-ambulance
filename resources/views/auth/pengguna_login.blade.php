                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">{{ __('Login User') }}</h1>
                                    </div>
                                    ...
                                    <form action="{{ route('auth.pengguna_login') }}" method="post" class="user">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <p>Belum punya akun? <a href="{{ route('auth.pengguna_register_form') }}"
