            ...
            <div class="p-4">
                ...
                <form action="" class="form" method="post">
                    ...
                    <div class="d-flex gap-2 flex-column mb-3">
                        ...
                        <input type="text" name="nama" id="" class="form-control" value="{{Auth::guard('pengguna')->user()->nama}}">
                    </div>
                    <div class="d-flex gap-2 flex-column mb-3">
                        <label for="" class="control-label fw-bold">No Telp</label>
                        <input type="text" name="noHP" id="" class="form-control" value="{{Auth::guard('pengguna')->user()->noHP}}">
                    </div>
                    <div class="d-flex gap-2 flex-column mb-3">
